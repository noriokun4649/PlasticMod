 ...
 */
public class ComponentVillagePlasticHouse extends StructureVillagePieces.Village
{
    private static final String __OBFID = "CL_00000517";

    public ComponentVillagePlasticHouse() {}

    public ComponentVillagePlasticHouse(StructureVillagePieces.Start p_i2094_1_, int p_i2094_2_, Random p_i2094_3_, StructureBoundingBox p_i2094_4_, int p_i2094_5_)
    {
    ...
    public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        this.spawnVillagers(p_74875_1_, p_74875_3_, 4, 1, 2, PlasticConfig.PlasticVillagerID);
		return false;
	}
	...
	protected int getVillagerType(int par1) {
		 ...
		 */
		return PlasticConfig.PlasticVillagerID;
	}
