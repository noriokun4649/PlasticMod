...
public class PlasticWirelessTNT extends Block
{
    ...
    public PlasticWirelessTNT()
    {
        super(Material.tnt);
        setBlockName("plasticWirelessTNT");
        setHardness(1.0F);
    ...
    public static void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
    ...
    {
    	player =p_149727_5_.getEntityId();
    	
    		PlasticCore.tntx =p_149727_2_;
    		PlasticCore.tnty =p_149727_3_;
    		PlasticCore.tntz =p_149727_4_;
    ...
    {
    	//if ( PlasticCore.tnttag =="true"){
        this.func_150114_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, 1,  (EntityLivingBase)null);
        //エアーブロックにチェンジ
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("plasticmod:wireless_plastictnt_side");
        this.field_150116_a = p_149651_1_.registerIcon("plasticmod:wireless_plastictnt_top");
        this.field_150115_b = p_149651_1_.registerIcon("plasticmod:wireless_plastictnt_bottom");
    }
