...
public class PlasticDoorBlock extends Block
{
    ...
    public PlasticDoorBlock(Material p_i45402_1_)
    {
        super(p_i45402_1_);
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    {
        if (this.blockMaterial == PlasticCore.rareplasticmate)
        {
    ...
    {
        return (p_149650_1_ & 8) != 0 ? null : (this.blockMaterial == PlasticCore.rareplasticmate ? PlasticCore.RarePlasticDoor : PlasticCore.PlasticDoor);
    }
    ...
    {
        return this.blockMaterial == PlasticCore.rareplasticmate ? PlasticCore.RarePlasticDoor : PlasticCore.PlasticDoor;
    }
