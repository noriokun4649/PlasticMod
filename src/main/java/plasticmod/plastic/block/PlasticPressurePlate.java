...
public class PlasticPressurePlate extends BlockBasePressurePlate
{
    private PlasticPressurePlate.Sensitivity field_150069_a;
    private static final String __OBFID = "CL_00000289";

    public PlasticPressurePlate(String p_i45418_1_, Material p_i45418_2_, PlasticPressurePlate.Sensitivity p_i45418_3_)
    {
    ...
    protected int func_150065_e(World p_150065_1_, int p_150065_2_, int p_150065_3_, int p_150065_4_)
    {
        ...
        if (this.field_150069_a == PlasticPressurePlate.Sensitivity.everything)
        {
            list = p_150065_1_.getEntitiesWithinAABBExcludingEntity((Entity)null, this.func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_));
        }

        if (this.field_150069_a == PlasticPressurePlate.Sensitivity.mobs)
        {
            list = p_150065_1_.getEntitiesWithinAABB(EntityLivingBase.class, this.func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_));
        }
        if  (this.field_150069_a == PlasticPressurePlate.Sensitivity.animal)
        {
            list = p_150065_1_.getEntitiesWithinAABB(EntityAnimal.class, this.func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_));
        }
        if (this.field_150069_a == PlasticPressurePlate.Sensitivity.players)
        {
