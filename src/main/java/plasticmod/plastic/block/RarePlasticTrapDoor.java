...
public class RarePlasticTrapDoor extends BlockTrapDoor
{
    /** Set this to allow trapdoors to remain free-floating */
    public static boolean disableValidation = false;
    private static final String __OBFID = "CL_00000327";

    public RarePlasticTrapDoor(Material p_i45434_1_)
    {
        super(p_i45434_1_);
        float f = 0.5F;
        float f1 = 1.0F;
        setBlockTextureName("plasticmod:rareplastictrapdoor");
        setBlockName("rareplastictrapdoor");
