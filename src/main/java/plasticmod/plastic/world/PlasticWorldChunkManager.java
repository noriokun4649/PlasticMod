...
public class PlasticWorldChunkManager extends WorldChunkManager {
	...
	public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(PlasticCore.plasticbiome,PlasticCore.plasticbiome2));
	static {
		for (int i = 0; i < 256; ++i) {
			if (i % 2 == 0) {
				biomeList[i] = PlasticCore.plasticbiome;
			} else if (i % 2 == 1) {
				biomeList[i] = PlasticCore.plasticbiome2;

			}
		}
	}

	protected PlasticWorldChunkManager() {
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList();
		this.biomesToSpawnIn.addAll(allowedBiomes);
	}

	public PlasticWorldChunkManager(long par1, WorldType par3WorldType) {
		this();
	...
	public PlasticWorldChunkManager(World par1World) {
