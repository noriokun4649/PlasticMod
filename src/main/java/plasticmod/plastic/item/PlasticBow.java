...
public class PlasticBow extends ItemBow
{
    ...
    {
        super();
        this.setUnlocalizedName("plasticbow");
        this.maxStackSize = 1;
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (/*flag ||*/ par3EntityPlayer.inventory.hasItem(PlasticCore.plasticarrow))

        {
            ...
            EntityPlasticArrow entityarrow = new EntityPlasticArrow(par2World, par3EntityPlayer, f * 2.0F);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(PlasticCore.plasticarrow))
        {
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon("plasticmod:plasticbow" + "_standby");
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = p_94581_1_.registerIcon("plasticmod:plasticbow" + "_" + bowPullIconNameArray[i]);
        }
    }
    @Override
