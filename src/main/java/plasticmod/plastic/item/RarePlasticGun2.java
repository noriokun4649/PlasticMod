...
public class RarePlasticGun2 extends Item
{
	...
	public RarePlasticGun2(int par1, float par2, double par3, int par4, int par5, String par6, Boolean par7, Boolean par8)
	{
		this.maxdamage = par1;
		this.range = par2;
		this.attack = par3;
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		{
			//弾があれば消費して耐久値回復
			if (par3EntityPlayer.inventory.hasItem(PlasticCore.rareplasticBullet2))
			{
				par3EntityPlayer.setItemInUse(par1ItemStack, this.getMaxItemUseDuration(par1ItemStack));
				par2World.playSoundAtEntity(par3EntityPlayer, "plasticmod:gun_reload", 10.0F, 1.0F); //装填音
				par3EntityPlayer.inventory.consumeInventoryItem(PlasticCore.rareplasticBullet2); //弾消費
			...
			if (par3EntityPlayer.attackTime == 0) //連射防止
			{
				...
				par2World.playSoundAtEntity(par3EntityPlayer, "plasticmod:gun2", 0.7F, 1.0F); //発射音
