...
public class RenderPlasticArrow extends Render
{

   private static final ResourceLocation TEXTURE = new ResourceLocation("plasticmod:textures/entity/plasticarrow.png");

    public RenderPlasticArrow()
    {
    }
   
    public void renderArrow(EntityPlasticArrow entityarrow, double d, double d1, double d2, 
            float f, float f1)
    {
            ...
            float f, float f1)
    {
       this.bindEntityTexture(entity);
        renderArrow((EntityPlasticArrow)entity, d, d1, d2, f, f1);
    }
