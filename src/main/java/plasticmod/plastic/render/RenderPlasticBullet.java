...
public class RenderPlasticBullet extends Render
{

   private static final ResourceLocation TEXTURE = new ResourceLocation("plasticmod:textures/entity/plasticbullet.png");

    public RenderPlasticBullet()
    {
    }
   
    public void renderArrow(EntityPlasticBullet entity, double d, double d1, double d2, 
            float f, float f1)
    {
            ...
            float f, float f1)
    {
       this.bindEntityTexture(entity);
        renderArrow((EntityPlasticBullet)entity, d, d1, d2, f, f1);
    }
