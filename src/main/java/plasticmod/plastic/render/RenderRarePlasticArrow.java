...
public class RenderRarePlasticArrow extends Render
{

   private static final ResourceLocation TEXTURE = new ResourceLocation("plasticmod:textures/entity/rareplasticarrow.png");

    public RenderRarePlasticArrow()
    {
    }
   
    public void renderArrow(EntityRarePlasticArrow entityarrow, double d, double d1, double d2, 
            float f, float f1)
    {
            ...
            float f, float f1)
    {
       this.bindEntityTexture(entity);
        renderArrow((EntityRarePlasticArrow)entity, d, d1, d2, f, f1);
    }
